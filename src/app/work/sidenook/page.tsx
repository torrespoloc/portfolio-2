  ...
  return (
    ...
    >
      <div className={sectionLeft}>
        <div className="flex items-center gap-3 mb-3">
          <motion.span
            ...
            className="inline-flex items-center justify-center h-8 w-8 rounded-md bg-foreground/[0.04] ring-1 ring-foreground/[0.06] text-foreground/70"
          >
      ...
      <div className={sectionRight}>
        <p className="text-base lg:text-lg text-foreground/70 leading-relaxed">{p.body}</p>
      </div>
    </motion.header>
  )
}
    ...
    <CaseStudyTemplatePra
      ...
      headline={
        <div className="space-y-4">
          ...
          <p className="max-w-2xl text-base lg:text-lg text-foreground/70 leading-relaxed">
        ...
        >
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="rounded-xl p-4 bg-background ring-1 ring-foreground/[0.06]">
            ...
            <div className="grid grid-cols-1 gap-6">
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <span className="text-label font-mono uppercase tracking-[0.2em] text-muted-foreground/80 px-2 py-0.5 rounded-full ring-1 ring-foreground/[0.08]">
        ...
        <section className="space-y-12 lg:space-y-16 pb-16 lg:pb-20">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <span className="inline-flex items-center justify-center h-7 w-7 rounded-md bg-foreground/[0.04] ring-1 ring-foreground/[0.06] text-foreground/70">
      ...
      <section id="impact" className="pb-24 lg:pb-28">
        ...
        >
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {outcomes.map((o, i) => (
              <li key={i} className="flex gap-4 p-5 rounded-xl bg-background ring-1 ring-foreground/[0.06]">
          ...
          <ul className="space-y-6">
            {differently.map((d) => (
              <li key={d.title} className="space-y-1.5">
                ...
                <p className="text-body-sm text-foreground/70 leading-relaxed">{d.body}</p>
              </li>
            ))}
          </ul>
        </motion.div>
