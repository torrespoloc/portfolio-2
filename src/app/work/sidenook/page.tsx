...
const meta = {
 ...
 <TooltipIcon src="/logos/claude-chat.png" alt="Claude" tooltip="Claude" className="h-6 w-6 " />
 <TooltipIcon src="/logos/claude-code.png" alt="Claude Code" tooltip="Claude Code" className="h-6 w-6 " />
 <TooltipIcon src="/logos/figma.svg" alt="Figma" tooltip="Figma" className="h-6 w-6 " />
 <TooltipIcon src="/logos/cursor.png" alt="Cursor" tooltip="Cursor" className="h-6 w-6 " />
 <TooltipIcon src="/logos/github.png" alt="GitHub" tooltip="GitHub" className="h-6 w-6 " />
 </div>
 ),
}
...
function PhaseHeader({ p, idx }: { p: Phase; idx: number }) {
 ...
 className="inline-flex items-center justify-center h-8 w-8 bg-secondary/70 ring-1 ring-hairline text-ink-muted"
 >
...
export default function SideNookCaseStudy() {
 ...
 <p className="max-w-2xl text-base lg:text-lg text-ink-muted leading-snug">
 ...
 >
 <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px overflow-hidden ring-1 ring-hairline bg-hairline">
 {[
 { icon: PanelRight, title: "Ambient panel", desc: "6pt collapsed pill. Expands on hover. Collapses when you leave. Zero screen space consumed when idle." },
 { icon: Zap, title: "Non-activating", desc: "Clicks route to the terminal, never steal focus from your current app. Works across all Spaces and fullscreen." },
 { icon: Columns, title: "Split panes", desc: "Vertical and horizontal splits. Independent shell sessions per pane. Drag to resize, keyboard shortcuts." },
 { icon: BookOpen, title: "CL Notes", desc: "Persistent monospaced notepad built into the panel. Line-number gutter, auto-save, inline or full tab." },
 { icon: HelpCircle, title: "Command reference", desc: "Searchable command library from a markdown file. Click any row to run it in the active terminal." },
 { icon: Palette, title: "Custom themes", desc: "Curated light and dark themes, custom accent colors, adjustable opacity, blur, and font controls." },
 ].map((f) => {
 const Icon = f.icon
 return (
 <div key={f.title} className="p-4 bg-background">
 <div className="flex items-center gap-2 mb-2">
 <Icon className="h-4 w-4 text-accent shrink-0" />
 <p className="text-label font-semibold text-foreground">{f.title}</p>
 </div>
 <p className="text-body-sm text-ink-muted leading-snug">{f.desc}</p>
 </div>
 )
 })}
 </div>
 ...
 />
 <p className="mt-2 text-body-sm font-mono uppercase tracking-[0.18em] text-ink-muted text-center">
 ...
 <div className="grid grid-cols-3 gap-px overflow-hidden ring-1 ring-hairline bg-hairline mb-8">
 {[
 { value: "50", label: "User testing participants" },
 { value: "90%", label: "Adoption rate" },
 { value: "94%", label: "Positive feedback" },
 ].map((m) => (
 <div key={m.label} className="flex flex-col items-center text-center bg-background p-6">
 <span className="text-3xl lg:text-4xl font-bold text-foreground tracking-tight leading-none mb-2">
 {m.value}
 </span>
 <span className="text-body-sm font-mono text-ink-muted leading-snug">
 {m.label}
 </span>
 </div>
 ))}
 ...
 {[
 "All I ever do is multitask. This makes it easier to do so.",
 "Honestly, I feared using the terminal until I tried this app.",
 "The status indicators are gold. I can't tell you how many times I have to go and check if Claude Code needs my attention.",
 ].map((q, i) => (
 <blockquote key={i} className="pl-4 border-l-2 border-accent/60 text-base lg:text-lg text-ink-muted italic leading-relaxed">
 &ldquo;{q}&rdquo;
 </blockquote>
 ))}
 </div>
 ...
 <p className="text-xs font-mono font-semibold uppercase tracking-[0.2em] text-brand-accent mb-2">
 The problem
 </p>
 ...
 >
 Every terminal demands your full attention. That&rsquo;s the problem.
 </motion.h3>
 </div>
 ...
 variants={fadeUp}
 transition={{ duration: 0.55, ease: [0.22, 1, 0.36, 1] }}
 className="text-base lg:text-lg text-ink-muted leading-snug list-disc pl-4 space-y-2"
 >
 ...
 className="text-base lg:text-lg text-muted-foreground leading-snug mb-6 max-w-2xl"
 >
 ...
 <div className="space-y-4">
 <div className="flex items-center gap-2">
 <span className="text-label font-mono uppercase tracking-[0.2em] text-white px-2 py-1 bg-accent">
 After · v1.0 shipped
 </span>
 ...
 <ul className="space-y-2 text-body text-ink-muted leading-snug">
 ...
 <p className="text-body-sm lg:text-body text-ink-muted italic leading-snug">
 ...
 className="p-4 lg:p-6 bg-secondary/40 ring-1 ring-hairline"
 >
 <p className="text-base lg:text-lg text-ink-muted leading-snug mb-4">
 ...
 <span className="px-4 py-2 bg-background ring-1 ring-hairline-strong text-ink-muted">User clicks panel</span>
 <span className="text-muted-foreground/40 text-base">→</span>
 <span className="px-4 py-2 bg-background ring-1 ring-hairline-strong text-ink-muted">AppKit activates window</span>
 <span className="text-chartreuse/50 text-base">→</span>
 <span className="px-4 py-2 bg-chartreuse ring-1 ring-chartreuse-foreground/20 text-chartreuse-foreground font-medium">SideNook intercepts ✗</span>
 <span className="text-muted-foreground/40 text-base">→</span>
 <span className="px-4 py-2 bg-background ring-1 ring-hairline-strong text-ink-muted">No app switch</span>
 </div>
 </motion.aside>
 ...
 <div className={sectionRight}>
 <ul className="text-base lg:text-lg text-ink-muted leading-snug list-disc pl-4 space-y-2">
 ...
 5. REFLECTION
 ═══════════════════════════════════════════════════════════════════════ */}
 <CaseStudySection id="reflection" className="space-y-16">
 <p className="text-xs font-mono font-semibold uppercase tracking-[0.2em] text-brand-accent mb-2">
 Reflection
 </p>
 ...
 <span className="inline-flex items-center justify-center h-8 w-8 bg-secondary/70 ring-1 ring-hairline text-ink-muted">
 ...
 <h3 className="text-xs font-mono uppercase tracking-[0.2em] text-accent">What I&rsquo;d do differently</h3>
 </div>
 ...
 className="inline-flex shrink-0 items-center justify-center h-9 gap-2 px-2 border border-white/30 text-sm font-medium whitespace-nowrap transition-all text-white hover:bg-white/10 hover:text-white"
 >
 Email me
 </a>
 <a
