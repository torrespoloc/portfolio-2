...
, {q.cite}
 ...
 <a
 href="/#work"
 className="inline-flex shrink-0 items-center justify-center h-9 gap-2 px-2 border border-transparent text-sm font-medium whitespace-nowrap transition-all text-background hover:text-background hover:bg-background/10"
 >
 More work
 </a>
 </div>
