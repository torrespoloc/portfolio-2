...
export default function XYCaseStudy() {
 ...
 <div>
 <p className="text-sm font-mono font-semibold uppercase tracking-[0.12em] text-accent mb-2">
 A note on confidentiality
 </p>
 <p className="text-base lg:text-lg text-ink-muted leading-relaxed">
 XY&rsquo;s product and customer data are protected by NDA. What you&rsquo;ll see in this case study are design artifacts I created — the component library, design system, workflow diagrams, and the story of how we got from zero to a self-serve AI platform. I&rsquo;m happy to walk through the full product experience in a conversation.
 </p>
 </div>
 </div>
 </div>
 ...
 Users orchestrated agents themselves. That self-serve UX became a <span className="text-case-highlight font-semibold">core sales asset</span>. <span className="text-case-highlight font-semibold">2 new clients</span> signed up from client demos.
 </p>
 ...
 {/* User feedback quote */}
 <blockquote className="pl-4 border-l-2 border-accent/60 text-base lg:text-lg text-ink-muted italic leading-relaxed mb-6">
...
, {userFeedback.cite}
 ...
 {/* CPO quote */}
 <div className="relative overflow-hidden bg-gradient-to-br from-accent/[0.06] to-background ring-1 ring-accent/[0.08] px-6 lg:px-8 pt-8 lg:pt-12 pb-8 lg:pb-10">
 <span
 aria-hidden
 ...
 <div className="w-10 h-10 bg-accent/[0.08] flex items-center justify-center shrink-0">
...
, {quote.cite}
 ...
 >
 Both groups needed to <span className="text-case-highlight font-semibold">see AI in action</span> before they'd configure it.
 </motion.h3>
 </div>
 <div className={`${sectionRight} space-y-4`}>
 <motion.p
 ...
 <p className="text-xs font-mono font-semibold uppercase tracking-[0.2em] text-brand-accent mb-2">Iteration</p>
 ...
 <p className="text-xs font-mono font-semibold uppercase tracking-[0.2em] text-brand-accent mb-2">Design system</p>
 ...
 <p className="text-xs font-mono font-semibold uppercase tracking-[0.2em] text-brand-accent mb-2">Validation</p>
 ...
 className="w-full h-auto ring-1 ring-foreground/[0.06]"
 />
 </motion.div>
 </motion.div>
 </CaseStudySection>
 ...
 <div>
 <p className="text-body font-semibold text-foreground mb-1">Design-to-engineering pipeline</p>
 <p className="text-body text-ink-muted leading-snug">
 ...
 <div>
 <p className="text-body font-semibold text-foreground mb-1">AI-powered workflow</p>
 <p className="text-body text-ink-muted leading-snug">
