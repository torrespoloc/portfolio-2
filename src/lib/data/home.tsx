...
export function getWorkCards(): WorkCard[] {
 ...
 metric1Value: "2 clients signed",
 metric2Label: "Setup",
 metric2Value: "Months to minutes",
 mediaSrcs: [
 ...
 year: "2025",
 metric1Label: "Practices",
 metric1Value: "3,000+",
 metric2Label: "In-clinic Conversion",
 metric2Value: "60%+",
 impactLabel: "User reach",
