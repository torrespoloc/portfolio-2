    ...
    <MotionConfig reducedMotion="user">
      ...
      <section className="pt-16 pb-12 relative z-10">
        <div className="mx-auto w-full max-w-container px-6">
          ...
          <p className="text-hero-muted text-body-sm sm:text-body mt-2 max-w-[480px]"></p>
        </div>
      </section>

      {/* One-up case study stack */}
            ...
            {visibleWorkCards.map((card, index) => {
              ...
              return (
                <React.Fragment key={card.href}>
                  ...
                  {!isLast && (
                    <div className="border-y border-hero-border/60 h-10 sm:h-[60px]" />
                  )}
                </React.Fragment>
              )
            })}
