...
export function HeroVideoOverlay({
 ...
 <div
 className="relative w-full overflow-hidden rounded-xl border border-white/10 bg-black shadow-2xl group animate-border-glow group-hover:animate-none"
 ...
 value={overlayTime}
 onChange={onSeek}
 className="flex-1 h-1 appearance-none bg-white/30 cursor-pointer accent-white
