...
export function MyJamFlipCard() {
  ...
  return (
    <div
      className="w-[calc(100%-24px)] max-w-none md:flex-1 md:min-w-[244px] md:max-w-[424px] cursor-pointer group"
    ...
    >
      <div className="animate-fade-in-up rotate-[2deg] relative" style={{ perspective: "1200px" }}>
        ...
        />
        <div
          className="relative min-h-[194px] rounded-[20px]"
          style={{
        ...
        >
          ...
          <div
            className="absolute inset-0 rounded-[20px] p-6 overflow-hidden"
            style={{
              backfaceVisibility: "hidden",
              background: "linear-gradient(135deg, #3B4AED 0%, #6C5CE7 100%)",
            }}
          >
            ...
            <p className="text-sm md:text-body font-semibold uppercase tracking-wider text-white/90 mb-3 relative z-10">
              My Jam <span className="inline-block animate-bounce-sm">👋</span>
            </p>
            <p className="text-sm md:text-body text-white/85 leading-relaxed font-semibold relative z-10 max-w-[360px]">
          ...
          <div
            className="absolute inset-0 rounded-[20px] p-5 md:p-6 flex flex-col overflow-hidden"
            style={{
              backfaceVisibility: "hidden",
          ...
          >
            ...
            <p className="flex-shrink-0 text-xs font-semibold uppercase tracking-[0.2em] text-chartreuse/85 relative z-10">
              Recruiter? HM? Mom!?
            </p>
            <div className="flex-shrink-0 w-full h-px bg-forest/60 mt-2 mb-4 relative z-10" />
            <div className="flex-1 flex flex-col items-start justify-start gap-1 relative z-10">
              {/* Line 1 — stacked metrics */}
              <div className="font-mono text-xs leading-snug md:text-lg text-white flex items-start gap-1 md:gap-2 w-full">
                <div className="flex flex-nowrap items-start justify-between gap-1 md:gap-2 whitespace-nowrap w-full min-w-0">
                  {METRICS.map((metric, index) => {
                    ...
                    return (
                      <div key={metric.label} className="flex items-start gap-1 md:gap-2 min-w-0">
                        ...
                        <div className="flex flex-col leading-none min-w-0">
                          ...
                          <span className="text-xs md:text-xs uppercase tracking-[0.02em] md:tracking-[0.14em] text-chartreuse/60 mt-1 font-semibold">
                            ({metric.label})
                          </span>
                        </div>
                      </div>
              ...
              {/* Line 2 — word by word */}
              <div className="font-mono text-[15px] leading-snug md:text-lg text-white/95 mt-1">
                <span>
