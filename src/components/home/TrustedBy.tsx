    ...
    >
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2">
          <div className="px-6 py-10 border-b sm:border-b-0 border-hero-border/35 sm:px-8 sm:pt-12 sm:pb-14">
          ...
          <div className="grid grid-cols-2 sm:border-l border-hero-border/35 w-full h-full">
              ...
              return (
                <div
                  ...
                  className={`flex h-full items-center justify-center px-4 py-4 sm:py-0 ${
                    !isLastInRow ? "border-r border-hero-border/35" : ""
                  } ${!isLastRow ? "border-b border-hero-border/35" : ""}`}
                >
                  <img
                    src={logo.src}
                    alt={logo.alt}
