...
export function TrustedBy({ className = "" }: Props) {
 ...
 className="rounded-none bg-white dark:bg-hero-card overflow-hidden"
 >
 <div className="grid grid-cols-1 sm:grid-cols-2">
 <div className="px-6 py-10 border-b sm:border-b-0 border-hero-border/60 sm:px-8 sm:pt-12 sm:pb-14">
 ...
 <div className="grid grid-cols-2 sm:border-l border-hero-border/60 w-full h-full">
 ...
 !isLastInRow ? "border-r border-hero-border/60" : ""
 } ${!isLastRow ? "border-b border-hero-border/60" : ""}`}
 >
 <img
 src={logo.src}
 alt={logo.alt}
 loading="lazy"
 className={cn("h-7 w-auto object-contain sm:h-8 trusted-by-logo", logoHeightOverrides[logo.alt])}
 />
 </div>
 );
 })}
