...
export function CaseStudyCard({
  ...
  return (
    <Tag
      ...
      className={cn(
        "group flex flex-col md:flex-row w-full h-full min-h-0 rounded-none overflow-hidden bg-card shadow-[0_1px_3px_0_rgba(0,0,0,0.05),0_1px_2px_-1px_rgba(0,0,0,0.05)] hover:shadow-[0_10px_30px_-5px_rgba(0,0,0,0.1),0_4px_10px_-6px_rgba(0,0,0,0.05)] transition-all duration-300",
        href && "cursor-pointer",
        className
      )}
    >
