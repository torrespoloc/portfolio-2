...
function TrafficLights() {
 ...
 <span className="block h-[11px] w-[11px] bg-[#febc2e]" />
 <span className="block h-[11px] w-[11px] bg-[#28c840]" />
 </div>
 )
}
...
function SidebarIconButton({
 ...
 return (
 <span
 className="flex-1 h-8 inline-flex items-center justify-center "
 style={{
...
export function SideNookMockAfter() {
 ...
 className="mx-auto w-full max-w-[864px] overflow-hidden ring-1 shadow-[0_24px_60px_-20px_rgba(0,0,0,0.65),0_0_0_1px_rgba(255,255,255,0.04)_inset] flex"
 ...
 <div
 className="w-[184px] h-full flex flex-col ring-1"
 style={{ background: tone.L2, borderColor: tone.stroke1 }}
 >
 {/* Traffic lights row */}
 <div className="h-8 flex items-center justify-between pr-1">
 <TrafficLights />
 <span className="inline-flex items-center justify-center h-7 w-7 text-white/35">
 ...
 <div
 className="h-8 px-2 flex items-center gap-2 ring-1"
 ...
 <span
 className="h-4 w-4 inline-flex items-center justify-center text-label text-white/55 leading-none"
