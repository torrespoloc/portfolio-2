...
export function BeforeAfterSlider({
 ...
 {/* Labels */}
 <span className="absolute top-4 left-4 text-label font-mono uppercase tracking-[0.18em] text-white/80 bg-black/50 backdrop-blur-sm rounded-md px-2 py-1 pointer-events-none">
 {beforeLabel}
 </span>
 <span className="absolute top-4 right-4 text-label font-mono uppercase tracking-[0.18em] text-white/80 bg-black/50 backdrop-blur-sm rounded-md px-2 py-1 pointer-events-none">
 {afterLabel}
 </span>
