  ...
  return (
    <div className="min-h-screen bg-hero-bg text-foreground relative">
      ...
      <main className="flex-1 min-w-0 relative px-6 lg:px-[160px]">
        <div
          aria-hidden="true"
          className="absolute inset-y-0 left-[160px] hidden lg:block w-px bg-hero-border/60 pointer-events-none z-10"
        />
        <div
          aria-hidden="true"
          className="absolute inset-y-0 right-[160px] hidden lg:block w-px bg-hero-border/60 pointer-events-none z-10"
        />
