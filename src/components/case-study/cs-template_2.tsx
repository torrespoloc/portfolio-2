...
export function CaseStudyTemplatePra({ headline, meta, metaTheme, heroImage, children }: CaseStudyTemplatePraProps) {
 ...
 <div className="absolute inset-y-0 left-sidebar w-px bg-hero-border/60 pointer-events-none z-40 hidden lg:block" aria-hidden="true" />
 ...
 <div className="absolute top-0 right-[10%] w-[504px] h-[504px] bg-chartreuse/[0.04] blur-3xl" />
 <div className="absolute top-[20%] left-[5%] w-[400px] h-[400px] bg-brand-blue/[0.04] blur-3xl" />
 <div className="absolute bottom-0 left-[40%] w-[304px] h-[304px] bg-burgundy/[0.03] blur-3xl" />
 </div>
 <motion.div
 ...
 <dl className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-0 overflow-hidden divide-x divide-hero-border/60 bg-background">
 {metaFields.map((m, i) => {
 const colorSet =
 ...
 <span className={`inline-block h-2 w-2 ${colorSet.dot}`} />
