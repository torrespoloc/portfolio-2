...
export function SideNookMockBefore() {
 ...
 className="mx-auto w-full max-w-[760px] overflow-hidden ring-1 ring-white/[0.10] shadow-[0_24px_60px_-20px_rgba(0,0,0,0.6),0_0_0_1px_rgba(255,255,255,0.04)_inset]"
 ...
 <span className="block h-4 w-[2px] bg-current" />
 <span className="block h-4 w-[2px] bg-current" />
 </div>
 ...
 <div
 key={t.title}
 className={`group flex items-center gap-2 pl-2.5 pr-2 py-1 min-w-0 ${
 active
 ...
 >
 {t.status === "waiting" && (
 <span className="absolute inline-flex h-full w-full bg-[#facc15]/60 animate-ping" />
 )}
 ...
 >
 <div className="h-2 w-12 bg-white/30 ring-1 ring-white/[0.06]" />
 ...
 className="flex flex-col items-center gap-2"
 >
 <div className="h-3 w-20 bg-white/40 ring-1 ring-white/[0.10]" />
 <span className="text-label font-mono uppercase tracking-[0.2em] text-white/45">
 Expanded · spring
 </span>
 </motion.div>
